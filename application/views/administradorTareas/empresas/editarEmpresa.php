	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0"> 
			<div class="panel-heading">
				<div class="panel-title"><h3><center>Editar Empresa</center></h3></div>
					...
					<form role="form" class="form-horizontal form-groups-bordered" method="POST">
						<div class="form-group" id="grupoNombre">
							...
							<div class="col-sm-5">
								<div class="input-group">
									...
									<input  name="NOMBRE" id="NOMBRE" type="text" class="form-control" value="<?php echo $emp[0]["NOMBRE"];?>">
								</div>
							</div>
						</div>
						<div class="form-group" id="grupoCodigo">
							...
							<div class="col-sm-5">
								<div class="input-group">
									<span class="input-group-addon">-</span>
									<input  name="CODIGO" id="CODIGO" type="text" class="form-control" value="<?php echo $emp[0]["CODIGO"];?>">
								</div>
							</div>
						</div>
