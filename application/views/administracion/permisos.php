		 		...
		 		<div class="row">
					<div class="col-md-12">
						<div class="alert alert-info"><strong>Info: </strong>
							Este administrador te permite editar los permisos que tiene cada usuario sobre el dashboard.
						</div>
					</div>
				</div>
				<?php
				...
				<table class="table table-bordered datatable" id="table-1">
	 		    	...
	 		    	<?php foreach ($usuarios as $key => $value): ?>
		 		    	<tr>
							...
							<td><a href="<?php echo base_url().'administracion/permisos/editar/'.$value['USER_UID'];?>"><button class="btn btn-success">Modificar</button></a></td>
		 		    	</tr>
	 		    	<?php endforeach;?>
	 		    </table>
				<?php endif;?>
