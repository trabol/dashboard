	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0"> 
			<div class="panel-heading">
				 <div class="panel-title"><h3><center>Cuentas contables </center></h3></div>
		 		...
		 		<div class="row">
					<div class="col-md-12">
						<div class="alert alert-info"><strong>Info: </strong>
							Este administrador te permite editar las cuentas contables asociadas a los autorizadores.
						</div>
					</div>
					...
					<div class="col-md-12" id="mensaje_borrado">
						<div class="alert alert-success"><strong>Mensaje: </strong>
							Cuentas contables eliminadas correctamente
						</div>
					</div>
					<?php endif;?>
				</div>
						...
						<div class="panel panel-danger" data-collapsed="0">
							<div class="panel-heading">
								<div class="panel-title">
									Eliminar cuentas contables del autorizador
								</div>
								<div class="panel-options">
							...
							<div class="panel-body">
								<form  id="form1" role="form" class="form-horizontal form-groups-bordered" method="POST" action="<?php echo base_url();?>mantenedor/cuentas-contables/<?php echo $user[0]->USR_UID;?>">
									...
									<div class="form-group">
										<label class="col-sm-3 control-label">
											<b>Cuentas contables asociadas al autorizador</b>
											<i class="entypo-right-bold"></i>
										</label>
										<div class="col-sm-6">
										<select multiple="multiple" name="my_select[]" class="form-control multi-select" id="my_select">
										<?php
										if(count($rutCuentas['rutCuentas'])>0){
											foreach ($rutCuentas as $key => $value){
												foreach ($value['usados'] as $v){
												echo "<option value='".$v['CUENTA']."'>".substr($v['CUENTA'],5)."-".$v['DESCRIPCION_CUENTA']."</option>";
												}
											}
										} 
										...
										<label class="col-sm-3 control-label" style="text-align: left;">
											...
											<b>Cuentas contables que serán eliminadas para este autorizador</b>
										</label>
									</div>
									<div class="form-group">
										<label class="col-sm-3 control-label"><b>opciones</b></label>
										<div class="col-sm-3">
										    <a href="<?php echo base_url();?>mantenedor/cuentas-contables">
