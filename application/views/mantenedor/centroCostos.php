	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0"> 
			<div class="panel-heading">
				 <div class="panel-title"><h3><center>Cargas Masivas</center></h3></div>
		 	...
		 	<div class="panel-body">
				<div class="row">
					<div class="col-sm-3"> 
						<a href="<?php echo base_url();?>mantenedor/centro-costos/carga-masiva">
							<div class="tile-title tile-green link1">
								<div class="icon"> <i class="glyphicon glyphicon-import"></i></div>
								<div class="title"> 
									<h3>Importar</h3><p>centro de costos</p>
								</div> 
							</div>
						</a> 
					</div>
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0"> 
			<div class="panel-heading">
				 <div class="panel-title"><h3><center>Lista de colaboradores: ISAPRES</center></h3></div>
				 <div class="panel-options">
				  	 <a href="#sample-modal" data-toggle="modal" data-target="#sample-modal-dialog-1" class="bg"><i class="entypo-cog"></i></a> <a href="#" data-rel="collapse"><i class="entypo-down-open"></i></a>
				  	  <a href="#" data-rel="reload"><i class="entypo-arrows-ccw"></i></a> 
				 </div>
				...
				<table class="table table-bordered datatable" id="table-1">
	 		    	...
	 		    	<?php foreach ($colaboradores as $key => $value): ?>
		 		    	<tr>
							...
							<td><a href="<?php echo base_url().'mantenedor/centro-costos/'.$value->USR_UID;?>"><button class="btn btn-success">Modificar</button></a></td>
		 		    	</tr>
	 		    	<?php endforeach;?>
	 		    </table>
				<?php endif;?>
