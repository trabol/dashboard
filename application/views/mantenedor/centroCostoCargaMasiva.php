	...
	<div class="col-lg-12">
		<div class="panel panel-primary" data-collapsed="0"> 
			<div class="panel-heading">
				 <div class="panel-title"><h3><center>Centro de costos / Carga masiva</center></h3></div>
		 	...
		 	<div class="panel-body">
		 	    ...
		 	    <p>Para mayor seguridad utilice esta plantilla para cargar los centros de costo</p>

		 		<a href="<?php echo base_url();?>assets/file/Ingresador_ccosto_plantillas.xlsx" target="_blank">
...
<div class="modal fade" id="modalMensajeOK">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h2><b>Los centro de costos fueron cargados correctamente</b></h2>
			</div>
			<div class="modal-footer">
...
$(document).ready(function($) {
	...
	$("#fileExcel").change(function(event){
		...
		if(fileExtension=="xlsx"){
			$.ajax({
				url: '<?php echo base_url();?>mantenedor/centro-costos/carga-masiva/cargar',
				type: 'POST',
				dataType: 'html',
				data: formData,
	    	    cache: false,
